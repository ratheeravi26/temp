# Databricks Notebook: Bronze Ingestion for GroupOwners_v0
# Purpose: Ingests raw GroupOwners_v0 data from ADLS Gen2 into a partitioned Bronze Delta table.
...
dbutils.widgets.text("input_base_path", "/mnt/adls_raw/m365/groupowners_v0", "Base Input Path for GroupOwners_v0")
dbutils.widgets.text("bronze_database_name", "m365_bronze", "Bronze Layer Database Name")
dbutils.widgets.text("bronze_table_name", "groupowners_v0", "Bronze Layer Table Name for GroupOwners")
...
# COMMAND ----------
# DBTITLE 5,Define Source Schema for GroupOwners_v0
# Based on Microsoft Graph Data Connect documentation for GroupOwners_v0
# Ref: https://github.com/microsoftgraph/dataconnect-solutions/blob/main/Datasets/data-connect-dataset-groupowners.md
group_owners_schema = StructType()
...
# COMMAND ----------
dbutils.notebook.exit("Successfully completed GroupOwners_v0 Bronze ingestion.")